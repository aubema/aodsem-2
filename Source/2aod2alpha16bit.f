...
c
         ...
         read(27,*)
         do 54 i=1,50
            read(27,*,end=56,err=57) bidon,tag
 57         if (bidon.eq.'#') then
              hcnt=hcnt+1
...
c
         ...
         do nx=1,nxtcel
           do ny=1,nytcel
               if (val(n,nx,ny).lt.65533.) then
                  val(n,nx,ny)=val(n,nx,ny)/1000.
               else
                  val(n,nx,ny)=65.534
               endif
           enddo
