...
c   applicable pour les donnees recues apres janvier 2003
c   Contact pour produire les fichiers CMC Lewis Poulin
c
c
       program gem2aodsem2
c
...
c
       ...
       integer nf,plevel(16),nl,k,i,j,RH(181,360,10),ncellz
       integer lenom,hre,min,sec,jou,moi,ann,prswitch,ptime,nfil,nfi
       integer bid,hre2,nhre(200),pr00s,pr06s,pr12s,joutmp
       real varp(200)
       real donnee(181,360,16),lcellx,lcelly,xcell0,ycell0,hcellz(10)
       real P(181,360,10),h0,P0,dP_dz(181,360,10),dP_dx(181,360,10),m,b
       real dP_dy(181,360,10),dx,dy,latt,VV(181,360,10),UU(181,360,10)
       real vz(181,360,10),dP_dt(181,360,10),dt,P2(181,360,10)
       real TT(181,360,10),ea,eta,ES(181,360,10),pi,PR06(181,360)
       real PR00(181,360),PR12(181,360),lcellz(10)
...
c
 ...
 110   enddo  
       ...
       do n=1,nlign
         ...
         if ((bidon(1:8).eq.'variable').or.
     +   (bidon(1:8).eq.'VARIABLE')) then
           backspace 2
...
c
     ...
     + sec,jou,moi,ann
       ...
       real vxwind(181,360,10),vywind(181,360,10),vzwind(181,360,10)
       character*60 wsfile
       zcell0=0.
...
c
     ...
     + lcellz,xcell0,ycell0,precip,ptime,jou,moi,ann)
       ...
       real lcellz(10),lcellx,lcelly,xcell0,ycell0,precip(181,360)
...
c
     ...
     + sec,jou,moi,ann
       integer ncelly,ncellz,t_drh(181,360,10)
       real lcellz(10),lcellx,lcelly,xcell0,ycell0,zcell0   
       character*60 rhfile  
       zcell0=0.
...
c
     ...
     + sec,jou,moi,ann
       integer ncelly,ncellz
       real lcellz(10),lcellx,lcelly,xcell0,ycell0,zcell0,tt(181,360,10)   
       character*60 ttfile  
       zcell0=0.
