...
c    base sur deux distributions 3D des aerosol fichier .dat
...
c
       character*60 nom1,nom2,nom3,datfil1,datfil2,datfil3,
     + obsfile,nomtype(5),binflag(12)
       real numvol1(5,12,125,275,10),numvol2(5,12,125,275,10),
     ...
     + ,nbns,lenbflag(12)
     + ,ncellx,ncelly,ncellz,lentype(5),nref
c   
c ----------
c
...
c
      open(unit=25,file='3darit.par',status='old',err=8)
       read(25,*) nom1
       read(25,*) nom2
...
c
     ...
     +             ,j=1,ncelly),i=ncellx,1,-1)
       ...
       print*,'100%'
       close(unit=20)
       open(unit=20,file=datfil2,status='old',err=4)
c ------------------------------------------
c
c   lecture des donnees de distribution des aerosols 
c   fichier1
c   les donnees sont en unites de 1.e+4 part/m^3
c
          print*,'Reading data file: ',datfil2(1:18)
          read(20,*) 
          read(20,*) 
          read(20,*) heure,minute,seconde,jour,mois,annee
          read(20,*) nbns
