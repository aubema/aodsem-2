c
c   Programme pour creer rapidement un fichier index pour les temperatures
c
c
       Program ttindex
c
...
c
       open(unit=1,file='tttemp',status='old')
       open(unit=2,file='airtmp.index',status='unknown')
       do n=1,1000
