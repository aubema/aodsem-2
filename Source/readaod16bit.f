...
c            read*,lat(i),lon(i)
 ...
 777     continue
         ...
         do 778 i=1,nsite
            ...
            if (tau(nxcen,nycen).gt.65532.) then
               print*,'AOD*1000 for site #',i,'= no data'
               write(11,*) 'AOD*1000 for site #',i,'= no data'
            else
               Print*,'AOD*1000 around site #',i
               print*,' '
               write(11,*) 'AOD*1000 around site #',i
               write(11,*) ' '
          do 998 ii=4,-4,-1
 ...
 998      continue
          ...
          do 996 ii=4,-4,-1
          do 997 iii=-4,4
            if (tau(nxcen+ii,nycen+iii).lt.65533.) then
